...
Address* setElement();
void xToEnd(Address* data, Address** phead, Address** plast);
...
int menu(void) {
	...
	cout << "4. Добавление x в конец списка" << endl;
	cout << "5. Поиск" << endl;
	cout << "6. Выход" << endl;
	cout << endl;
	do
...
void xToEnd(Address* data, Address** phead, Address** plast) { //Добавление x в конец списка 
	Address* p = *plast;
...
int main(void) {
	...
	while (true)
	{
		...
		case 3:  outputList(&head, &last);
			break;
		case 4: xToEnd(setElement(), &head, &last);
			break;
